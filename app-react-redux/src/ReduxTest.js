...
// responsável pela comunicação entre os componentes através de react-redux e seu state
...
// ReduxTest function é um componente de react para ser renderizado em index.js na raiz do projeto
function ReduxTest() {
    /* 
    ...
    **/
    ...
    return (
      <div className="App">
        <header style={{background: '#255'}} className="App-header">
  ...
  export default ReduxTest; // exportar como padrão (default) o componente ReduxTest